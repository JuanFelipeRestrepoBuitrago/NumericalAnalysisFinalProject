function calculateSecondModifiedNewton() {
   ...
   // Agregar "derivative_expression" solo si el usuario lo ha proporcionado y no es null
   if (derivative_expression && derivative_expression.trim() !== "") {
       data.derivative_expression = derivative_expression;
   }

   // Agregar "second_derivative_expression" solo si el usuario lo ha proporcionado y no es null
   if (second_derivative_expression && second_derivative_expression.trim() !== "") {
       data.second_derivative_expression = second_derivative_expression;
   }
   ...
   // Mostrar el objeto de datos para verificar
