...
def test_iterative_solve():
    ...
    assert float(result[-1][-1]) < 0.5e-4, "Test 1 failed for iterative_solve"
    ...
    assert float(result[-1][-1]) < 0.5e-4, "Test 2 failed for iterative_solve"
    ...
    assert float(result[-1][-1]) < 0.5e-4, "Test 3 failed for iterative_solve"
    ...
    assert float(result[-1][-1]) < 0.5e-4, "Test 4 failed for iterative_solve"
