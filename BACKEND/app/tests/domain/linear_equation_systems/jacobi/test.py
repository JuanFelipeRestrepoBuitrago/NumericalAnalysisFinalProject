...
def test_iterative_solve():
    ...
    assert result[1][1][1] == "-4.000000000000000", "Test 1 failed for iterative_solve"
    ...
    assert result[1][1][1] == "-4.000000000000000", "Test 2 failed for iterative_solve"
    ...
    assert result[1][1][1] == "-4.000000000000000", "Test 3 failed for iterative_solve"
    ...
    assert result[1][1][1] == "-4.000000000000000", "Test 4 failed for iterative_solve"
    ...
    assert "2.73241609" in result[2][-1], "Test 5 failed for iterative_solve" 
