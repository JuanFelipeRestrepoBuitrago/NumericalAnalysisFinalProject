...
def test_partial_pivot():
    ...
    result = object.partial_pivot(Ab=A, k=0, n=3)
    ...
    result = object.partial_pivot(Ab=A, k=0, n=4)
    ...
    result = object.partial_pivot(Ab=A, k=3, n=5)
...
def test_total_pivot():
    ...
    result, mark = object.total_pivot(Ab=A, n=3, k=0, mark=np.array([0, 1, 2]))
    ...
    result, mark = object.total_pivot(Ab=A, n=4, k=0, mark=np.array([0, 1, 2, 3]))
